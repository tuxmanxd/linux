...
({ \
	...
	mipi_dsi_dcs_write(dsi, d[0], d + 1, ARRAY_SIZE(d) - 1); \
})

#define nt35521_switch_page(dsi_ctx, page) \
	mipi_dsi_dcs_write_seq(dsi_ctx, NT35521_DCS_SWITCH_PAGE, \
...
static int truly_nt35521_on(struct truly_nt35521 *ctx)
{
	...
	nt35521_switch_page(dsi, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0xaa, 0x55, 0xa5, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x6f, 0x11, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xf7, 0x20, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x6f, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01, 0xa0, 0x10, 0x08, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0x01, 0x02, 0x0c, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x11, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x02);

	nt35521_switch_page(dsi, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x09, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x09, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x8c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x8c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc0, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xbe, 0xb5);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x35, 0x35);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x25, 0x25);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x43, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x24, 0x24);

	nt35521_switch_page(dsi, 0x02);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x96, 0x03, 0x98);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0x03, 0xb8, 0x03, 0xba);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x03, 0xf6, 0x03, 0xf7);

	nt35521_switch_page(dsi, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x22, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x22, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x05, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x05, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x05, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x05, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x53, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x53, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x53, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x53, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc0, 0x00, 0x34, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc1, 0x00, 0x00, 0x34, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x00, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x02, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x02, 0x03);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xed, 0x30);

	nt35521_switch_page(dsi, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x2d, 0x2e);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x31, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x29, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x12, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x18, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0x00, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0x08, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x31, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x03, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x17, 0x19);
	mipi_dsi_dcs_write_seq(dsi, 0xbe, 0x11, 0x13);
	mipi_dsi_dcs_write_seq(dsi, 0xbf, 0x2a, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0xc0, 0x34, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xc1, 0x2e, 0x2d);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xc4, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xc5, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xc6, 0x2e, 0x2d);
	mipi_dsi_dcs_write_seq(dsi, 0xc7, 0x31, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0xc8, 0x29, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0xc9, 0x17, 0x19);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x11, 0x13);
	mipi_dsi_dcs_write_seq(dsi, 0xcb, 0x03, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xcc, 0x08, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xcd, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xce, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xcf, 0x31, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xd0, 0x00, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xd1, 0x12, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0xd2, 0x18, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0xd3, 0x2a, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0xd4, 0x34, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xd5, 0x2d, 0x2e);
	mipi_dsi_dcs_write_seq(dsi, 0xd6, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xd7, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xe5, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xe6, 0x31, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0xd8, 0x00, 0x00, 0x00, 0x00, 0x00);
...
{
	struct truly_nt35521 *ctx = bl_get_data(bl);
	u16 brightness = backlight_get_brightness(bl);
	gpiod_set_value_cansleep(ctx->blen_gpio, brightness > 0);
	int ret;
